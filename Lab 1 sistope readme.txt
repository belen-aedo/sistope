...
los archivos ejemplo cd Escritorio/21556446-0_21317055-4/sistope-master/lab1, despuès en bash ./generator.sh -i number -
t number | ./preprocess.sh | ./filter.sh -c number -m number -r "Process name" | ./transform.sh --anon-uid | 
./aggregate.sh \ | ./report.sh -o reporte.tsv (o .csv). En donde number, puede ser cualquier número positivo. En donde 
primero se capturan los datos con generator, luego se le da un formato específico con preprocess, para filtrar por 
